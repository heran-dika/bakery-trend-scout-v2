...
def generate_report() -> str:
    ...
    cursor.execute("""
        SELECT dt.id, dt.trend_name, dt.mention_count, dt.status, dt.trend_origin
    ...
    domestic_trends = [t for t in trends if t[4] == "Domestic"]
    global_trends = [t for t in trends if t[4] == "Global"]
